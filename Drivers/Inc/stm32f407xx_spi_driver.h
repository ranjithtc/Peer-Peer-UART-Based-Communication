...
/*
 * Configure the structure for SPI peripheral
 */
typedef struct
{
...
/*
 * Handle Structure for pSPIx peripheral
 */
typedef struct
{
	SPI_RegDef_t	*pSPIx;
...
#define SPI_CPHA_FTR		0
#define SPI_CPHA_STR		1
...
/*
 * @GetFlagStatusof the Status Register
 */
