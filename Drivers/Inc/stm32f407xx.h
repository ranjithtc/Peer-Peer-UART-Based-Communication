...
#define FLASH_BASEADDR						0x08000000U   		/*Flash base Address of the Microcontroller*/
#define SRAM1_BASEADDR						0x20000000U  		/*SRAM1 Address of the Microcontroller*/
#define SRAM2_BASEADDR						0x2001C000U 		/*SRAM2 Address of the Microcontroller*/
#define ROM_BASEADDR						0x1FFF0000U			/*System memory of RAM Base Address of the microcontroller*/
#define SRAM 								SRAM1_BASEADDR		/*Main SRAM Address is the Base address of the SRAM1*/
